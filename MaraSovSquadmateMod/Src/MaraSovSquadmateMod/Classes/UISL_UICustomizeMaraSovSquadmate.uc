...
//---------------------------------------------------------------------------------------
class UISL_UICustomizeMaraSovSquadmate extends UIScreenListener;
...
{
    if( BodyPart.DLCName == 'MaraSovSquadmateMod' )
    {
        return class'UIUtilities_Text'.static.InjectImage("img:///MaraSovSquadmate_Assets.UIIcon_Awoken_Icon", 26, 26, -4) $ " ";
    }
    return "";
}
